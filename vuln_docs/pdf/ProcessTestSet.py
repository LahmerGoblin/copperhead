...
vectorizer = None
class_pipeline = None
model_path = 'tfidf_svm_folderstructure_classpipe.pickle'
out_path = 'out_tfidf_svm_folderstructure.pickle';
...
output = [ out+'\n' for out in output] 
with codecs.open('copperhead_testset_02_docx_svm_tfidf_folderstructure.csv','wb','utf-8') as out_file:
